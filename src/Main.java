public class Main {
    public static void main(String[] args) {
        ...
        AVLTree treeAvl = new AVLTree();
         ...
         System.out.println("Árvore AVL após inserção de valores (10-90):");
         tree.printTree();
         System.out.println("Altura da árvore: " + treeAvl.height());
         treeAvl.clear(); System.out.println("Conteúdo da árvore após limpeza:");
         int[] values2 = {90, 80, 70, 60, 50, 40, 30, 20, 10};
         for (int value : values2) { treeAvl.add(value); }
